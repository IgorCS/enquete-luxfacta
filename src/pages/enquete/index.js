    ...
    <ScrollView style={styles.geral}>
      <View style={styles.MainContainer}>
        <View style={styles.sectionTopo}>
          <Text style={styles.text}> Enquete</Text>
          <Text style={styles.subtText}>
            {' '}
            {radio_candidatos.length > 0
              ? 'Selecione a opção que deseja votar e clique em salvar'
              : 'Nenhuma opção encontrada no momento, clique na opção cadastrar.'}
          </Text>
        </View>
